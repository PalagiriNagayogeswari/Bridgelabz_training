/*Extended the previous program to create a Player Object having Deck of Cards, and
having ability to Sort by Rank and maintain the cards in a Queue implemented
using Linked List.Further the Players are also
arranged in Queue. Finally Printed the Player and the Cards received by each
Player.*/

import java.util.Random;
//Created PlayerNode to store players details
class PlayerNode {
...
//PlayerQueue to store the players.
class PlayerQueue {
