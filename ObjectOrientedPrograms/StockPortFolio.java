...
//stock class of holding all the stock details
class stock{
    String shareName;
    int NumberOfShares;
    int shareprice;
    ...
    //non static method to calculate total price of each stock
    public int priceofeachshare(int shares,int price){
        return shares*price;
    }
}

//StockPortFolio class of handling all the funtionality
